...
import { validateP2Evidence } from "./p2-evidence.mjs";
...
const manifest = JSON.parse(await readFile(resolve(evidenceDirectory, "manifest.json"), "utf8"));
const cases = JSON.parse(await readFile(resolve(evidenceDirectory, "cases.json"), "utf8"));
