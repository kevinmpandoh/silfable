        ...
        <div className="grid gap-14 lg:grid-cols-[1fr_0.65fr] lg:items-end">
          <div>
            <div className="flex flex-wrap items-center gap-3">
              <Badge>Latest stable</Badge>
              <span className="font-mono text-[9px] uppercase tracking-[0.18em] text-white/35">Released July 10, 2026</span>
            </div>
            <h1 className="mt-8 font-serif text-[clamp(4.5rem,11vw,11rem)] leading-[0.75] tracking-[-0.07em]">
              Silfable <em className="block pl-[8vw] text-electric">1.2.0</em>
            </h1>
          </div>
          <div className="border-t border-white/15 pt-7 lg:mb-2">
            ...
            <div className="mt-7 flex flex-wrap gap-x-6 gap-y-3 font-mono text-[9px] uppercase tracking-[0.16em] text-white/35">
              <span className="flex items-center gap-2"><CheckCircle2 className="size-3.5 text-emerald-400" /> Signed</span>
              <span className="flex items-center gap-2"><CheckCircle2 className="size-3.5 text-emerald-400" /> Notarized</span>
