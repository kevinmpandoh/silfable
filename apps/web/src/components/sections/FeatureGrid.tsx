...
export function FeatureGrid() {
  ...
  return <section className="solarSection"><div className="section-shell">
    <header className="solarSectionHeader"><div><span className="solarEyebrow">CAPABILITY CURRENT</span><h2>One stream.<br />Four operator paths.</h2></div><p>Choose the action, inspect the prepared route, and keep authority in the wallet. Each capability follows the same review-first execution model.</p></header>
