      ...
      <div className="section-shell py-24 sm:py-32 lg:py-44">
        ...
        >
          ...
          <p className="max-w-xl text-base leading-8 text-white/55 lg:justify-self-end">
            ...
            Tested and verified across multiple successful real-world scenarios as outlined in our whitepaper.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="overflow-hidden rounded-[1.25rem] border border-cyan-300/20 bg-[#07101f] shadow-[0_26px_90px_rgb(0_0_0_/_0.35)] sm:rounded-[1.75rem]"
        >
          <Image
            src="/ss1.png"
