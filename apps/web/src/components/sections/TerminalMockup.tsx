...
export function TerminalMockup() {
  return <section className="solarSection"><div className="section-shell">
    <CurrentReveal className="solarSectionHeader"><div><span className="solarEyebrow">EXECUTION WORKFLOW</span><h2>From intent to settlement,<br />nothing disappears.</h2></div><p>Preparation, simulation, wallet approval, and settlement remain distinct so operators always know what has—and has not—happened.</p></CurrentReveal>
