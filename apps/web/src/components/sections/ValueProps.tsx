...
export function ValueProps() {
  return <section id="networks" className="solarSection solarEcosystem"><div className="section-shell">
    <CurrentReveal className="solarSectionHeader"><div><span className="solarEyebrow">PRIMARY ECOSYSTEM</span><h2>Built for the speed<br />of Solana.</h2></div><p>Solana leads the experience from wallet context to settlement. Connected EVM routes stay available without competing for the primary workflow.</p></CurrentReveal>
