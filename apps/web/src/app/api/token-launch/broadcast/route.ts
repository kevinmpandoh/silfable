...
import { inspectPumpLaunchBroadcastTransaction, TOKEN_2022_PROGRAM_ID } from "@/lib/pump-launch-core";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    inspectPumpLaunchBroadcastTransaction(transaction, walletAddress, mintAddress);
