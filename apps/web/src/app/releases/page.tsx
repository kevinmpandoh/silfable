...
export const metadata: Metadata = {
  title: "Changelog - Mirae",
  description: "Review Mirae product changes, desktop builds, checksums, compatibility, and update channels.",
};
  ...
  return (
    <PageTransition>
      <main className="publicPage releasesTheme bg-paper text-ink">
        <ReleaseHero />
        <div className="section-shell releaseConsoleBody">
          <ReleaseDownloads />
          <ReleaseHistory />
          <UpdatePolicy />
        </div>
