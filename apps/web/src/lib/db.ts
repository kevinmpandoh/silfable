...
export interface WebProposal {
  ...
  launchCreatorBuyLamports?: string;
  launchMaximumCreatorBuyLamports?: string;
  launchExpectedCreatorTokensRaw?: string;
  launchCreatorBuySlippageBps?: number;
...
export type InvestmentAssetClass = "crypto" | "stablecoin" | "tokenized_stock" | "tokenized_etf";
...
export interface InvestmentAllocation {
  ...
  trackingDeviationPct?: number | null;
...
export interface InvestmentRecommendation {
  ...
  tokenizedStockDisclosure: string;
  dataWarnings: string[];
}
