  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>
          Mirae will refresh policy evidence, request an unsigned Jupiter
  ...
  return (
    <div className="modalBackdrop" role="presentation">
      ...
      >
        ...
        <Notice tone="warning" title="Irreversible Mainnet transaction">
          This signs locally and submits a real Mainnet transaction. Mirae
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>
          Mirae will sign Jupiter's authentication message locally, retrieve
