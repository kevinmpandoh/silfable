      ...
      <div className="flex max-h-[90vh] w-full max-w-4xl flex-col overflow-hidden rounded-2xl border border-[rgb(32_33_42_/_0.15)] bg-white text-[#20212A] shadow-2xl">
        ...
        <div className="flex items-center justify-between border-b border-[#20212A]/10 bg-[#FAFAFB] px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-bold text-[#20212A]">Drift Perpetuals (Solana Mainnet)</h2>
              <p className="text-xs text-[#686970]">Non-custodial on-chain perpetual futures with local vault security</p>
            </div>
          </div>
          <button
            type="button"
        ...
        <div className="grid grid-cols-2 gap-3 border-b border-[#20212A]/10 bg-[#F6F7F9] px-6 py-3 sm:grid-cols-4">
          <div>
            <span className="text-[10px] font-medium uppercase tracking-wider text-[#686970]">Free Collateral</span>
            <p className="text-sm font-bold text-[#20212A]">${freeCollateral.toFixed(2)} USDC</p>
          </div>
          <div>
        ...
        <div className="grid flex-1 gap-6 overflow-y-auto p-6 md:grid-cols-[1.1fr_1fr]">
          {/* Markets Watchlist */}
          <div>
            <h3 className="mb-3 text-xs font-semibold uppercase tracking-wider text-[#686970]">Allowlisted Markets</h3>
            {loading ? (
              <div className="py-8 text-center text-xs text-[#686970]">Loading live Drift markets…</div>
            ) : (
                ...
                return (
                  ...
                  >
                    <div>
                      ...
                      <span className="text-xs text-[#686970]">Oracle: <strong className="text-[#20212A]">${m.oraclePriceUsd.toLocaleString()}</strong></span>
                    </div>
                    <div className="text-right">
                      ...
                      <span className="text-[10px] text-[#686970]">OI: {m.openInterestLongBase} {m.baseAssetSymbol}</span>
                    </div>
                  </button>
                  );
                })}
            ...
            <div className="space-y-4">
              ...
              {!hasCollateral && (
                <div className="flex items-center gap-1.5 text-[11px] font-medium text-amber-700">
                  ...
                  <span>Insufficient Free Collateral (${freeCollateral.toFixed(2)} available, requires ${marginRequired}).</span>
                </div>
              )}
            </div>
