...
export const IPC_CHANNELS = {
  ...
  driftMarketsGet: "drift:get-markets",
  driftAccountGet: "drift:get-account",
  driftOrderPrepare: "drift:prepare-order",
  driftOrderExecute: "drift:execute-order",
...
export const DriftPerpMarketSchema = z.object({
  marketIndex: z.number().int().nonnegative(),
  symbol: z.string().min(1),
  baseAssetSymbol: z.string().min(1),
  oraclePriceUsd: z.number(),
  fundingRateHourlyPctLong: z.number(),
  fundingRateHourlyPctShort: z.number(),
  openInterestLongBase: z.number(),
  openInterestShortBase: z.number(),
  maxLeverage: z.number(),
  minOrderBase: z.number(),
  stepSizeBase: z.number(),
});
export type DriftPerpMarket = z.infer<typeof DriftPerpMarketSchema>;

export const DriftPerpPositionSchema = z.object({
  marketIndex: z.number().int().nonnegative(),
  symbol: z.string().min(1),
...
export type DriftPerpPosition = z.infer<typeof DriftPerpPositionSchema>;

export const DriftPerpAccountSchema = z.object({
  walletAddress: z.string(),
  accountExists: z.boolean(),
  userAccountAddress: z.string(),
  collateralUsd: z.number(),
  freeCollateralUsd: z.number(),
  unrealizedPnlUsd: z.number(),
  leverage: z.number(),
  healthPct: z.number(),
  positions: z.array(DriftPerpPositionSchema),
});
export type DriftPerpAccount = z.infer<typeof DriftPerpAccountSchema>;

export const DriftPerpProposalSchema = z.object({
  id: z.string(),
  type: z.literal("drift_perp_order"),
  market: z.string(),
  ...
  notionalUsd: z.number(),
  limitPriceUsd: z.number().nullable().optional(),
  leverage: z.number(),
  marginRequiredUsd: z.number(),
  freeCollateralUsd: z.number(),
  fundingRateHourlyPct: z.number(),
  status: z.string(),
  mode: z.string(),
  venue: z.string(),
  ...
  account: DriftPerpAccountSchema.optional(),
  plan: z.any().optional(),
});
export type DriftPerpProposal = z.infer<typeof DriftPerpProposalSchema>;
...
export const PerpMarketSchema = z.object({
  ...
  fundingRateHourlyPctLong: z.number(),
  fundingRateHourlyPctShort: z.number(),
  openInterestBase: z.number(),
  maxLeverage: z.number(),
  minOrderBase: z.number(),
  stepSizeBase: z.number(),
  takerFeeBps: z.number(),
  oracleSlot: z.number(),
  oracleAgeSlots: z.number(),
  stale: z.boolean(),
});
...
export const PerpOrderPlanSchema = z.object({
  ...
  oraclePriceUsd: z.string(),
  limitPriceUsd: z.string().nullable(),
  networkFeeLamports: z.string(),
  simulationSlot: z.number(),
  computeUnitsConsumed: z.number().nullable(),
  invokedPrograms: z.array(z.string()),
...
export const PerpProposalSchema = z.object({
  ...
  leverage: z.number(),
  oraclePriceUsd: z.string(),
  limitPriceUsd: z.string().nullable().optional(),
  networkFeeLamports: z.string(),
  status: z.string(),
  mode: z.string(),
  venue: z.string(),
