...
Later launches do not repeat onboarding. Mirae runs the system check, asks for the configured master password, and then opens the existing workspace. Minimizing or closing the window to the tray locks the vault and requires this entry flow again.
